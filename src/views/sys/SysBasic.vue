<template>
  <div>
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      ...
      <el-tab-pane label="职称管理" name="JoblebelMana"><JoblebelMana/></el-tab-pane>
      <el-tab-pane label="权限管理" name="PermissMana"><PermissMana/></el-tab-pane>
    </el-tabs>
  </div>
</template>
...
export default {
  ...
  components: { DepMana, EcMana, JoblebelMana, PermissMana, PosMana },
};
</script>
